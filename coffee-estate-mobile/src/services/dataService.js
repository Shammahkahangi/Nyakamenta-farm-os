...
import { getEstateApi, tryGetEstateApi } from '../api/estateApi';
import { isManagerRole, isSaccoLead, isLodgeLead } from '../auth/estateRole';
...
const dataService = {
    ...
    async _fileToBase64(file) {
        ...
        if (!file.arrayBuffer) throw new Error('Unsupported file object');
    ...
    async uploadLogbookAttachment({ parent_type, parent_id, file }) {
        ...
        const payload = {
            ...
            mime_type: file.type || file.mimeType || null,
            base64,
        };
